...
-- delete an Owner
DELETE FROM Owneres WHERE id = :owner_ID_selected_from_browse_owner_page
...
DELETE FROM Prescription WHERE id = :prescriptionIDSelectedFromBrowsePrescriptionPage
